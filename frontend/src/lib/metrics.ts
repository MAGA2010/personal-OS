...
const MOCK_NORMALIZED: Record<string, Partial<Record<MetricId, number>>> = {
  // ── Northeast ──
  "25": { income: 0.85, safety: 0.72, employment: 0.80, cost: 0.78,chinese_population: 0.62 }, // MA
  "36": { income: 0.80, safety: 0.60, employment: 0.82, cost: 0.80,chinese_population: 0.88 }, // NY
  "34": { income: 0.82, safety: 0.68, employment: 0.75, cost: 0.74,chinese_population: 0.52 }, // NJ
  "42": { income: 0.72, safety: 0.65, employment: 0.78, cost: 0.76,chinese_population: 0.45 }, // PA
  "09": { income: 0.78, safety: 0.70, employment: 0.79, cost: 0.77,chinese_population: 0.50 }, // CT

  // ── Midwest ──
  "17": { income: 0.70, safety: 0.55, employment: 0.72, cost: 0.70,chinese_population: 0.48 }, // IL
  "39": { income: 0.65, safety: 0.62, employment: 0.68, cost: 0.68,chinese_population: 0.25 }, // OH
  "26": { income: 0.62, safety: 0.58, employment: 0.70, cost: 0.69,chinese_population: 0.30 }, // MI
  "55": { income: 0.66, safety: 0.64, employment: 0.66, cost: 0.65,chinese_population: 0.20 }, // WI
  "27": { income: 0.68, safety: 0.60, employment: 0.67, cost: 0.66,chinese_population: 0.22 }, // MN

  // ── South ──
  "48": { income: 0.68, safety: 0.50, employment: 0.74, cost: 0.73,chinese_population: 0.38 }, // TX
  "12": { income: 0.64, safety: 0.52, employment: 0.73, cost: 0.72,chinese_population: 0.32 }, // FL
  "13": { income: 0.66, safety: 0.54, employment: 0.71, cost: 0.71,chinese_population: 0.28 }, // GA
  "37": { income: 0.63, safety: 0.56, employment: 0.69, cost: 0.67,chinese_population: 0.22 }, // NC
  "51": { income: 0.70, safety: 0.62, employment: 0.70, cost: 0.70,chinese_population: 0.25 }, // VA

  // ── West ──
  "06": { income: 0.90, safety: 0.55, employment: 0.85, cost: 0.85,chinese_population: 0.95 }, // CA
  "53": { income: 0.76, safety: 0.65, employment: 0.72, cost: 0.70,chinese_population: 0.42 }, // WA
  "41": { income: 0.72, safety: 0.68, employment: 0.70, cost: 0.68,chinese_population: 0.28 }, // OR
  "04": { income: 0.58, safety: 0.55, employment: 0.65, cost: 0.64,chinese_population: 0.18 }, // AZ
  "32": { income: 0.60, safety: 0.52, employment: 0.64, cost: 0.62,chinese_population: 0.15 }, // NV
  "08": { income: 0.74, safety: 0.62, employment: 0.68, cost: 0.66,chinese_population: 0.20 }, // CO
};
